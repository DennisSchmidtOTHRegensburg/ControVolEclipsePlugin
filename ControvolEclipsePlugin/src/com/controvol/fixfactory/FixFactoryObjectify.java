...
/*
 * Create a list of fixes for Objectify for a given warning
 * */
public class FixFactoryObjectify implements FixFactory {
	
	public FixFactoryObjectify(){}
	...
	public List<Fix> getCodeFixes(IWarning warning){
		...
		if (warning instanceof AttributeDeleted){
			...
			// Fix 1: Add @Ignore
			annotation = ie.ucd.pel.engine.util.CstObjectify.ANNOTATION_IGNORE_1;
			...
			// Fix 3 for Deleted: Restore Attribute and Add @IgnoreSave
			annotation = ie.ucd.pel.engine.util.CstObjectify.ANNOTATION_IGNORESAVE_1;
			type = UtilPlugin.getClassNameWithoutPackage(warningAttDel.getOperation().getAttribute().getType());
			...
			// Fix 1: Add @AlsoLoad("formerAttribute")
			annotation = ie.ucd.pel.engine.util.CstObjectify.ANNOTATION_ALSOLOAD_1;
			...
			// Fix 2 for TypeWarning: Add @IgnoreSaved + migration-method
			annotation = ie.ucd.pel.engine.util.CstObjectify.ANNOTATION_IGNORESAVE_1;
			String advancedmigration = CstObjectify.ANNOTATION_ONLOAD_1 + CstJava.LINE_BREAK + CstJava.TAB + CstPlugin.MIGRATION + formerName + CstJava.BRACKET_1 + CstJava.BRACKET_2 + CstPlugin.COMMEND_1 + CstPlugin.MIG_MESSAGE_1 + currentName + CstPlugin.MIG_MESSAGE_2 + currentName + CstPlugin.MIG_MESSAGE_3 + CstPlugin.COMMEND_2;
